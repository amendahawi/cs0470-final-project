...
public class TravelCLI {
	...
	private static void printAllTrips(TripBook tbook) {
	...
	private static void printAllActivities(Trip trip) {		
	...
	// Trips Methods
	private static void editTrip(TripBook tbook, Trip trip) {
	...
	private static void addNewActivitytoTrip(Trip trip) {
	...
	private static void editTripDetails(TripBook tbook, Trip trip) {
	...
	private static void editTripDate(Trip trip) {
	...
	private static void editTripStartDate(Trip trip) {
		printSeparator();
	...
	private static void editTripEndDate(Trip trip) {
		printSeparator();
	...
	private static void editTripBudget(Trip trip) {
	...
	private static void setTripBudget(Trip trip) {
		printSeparator();
	...
	private static Trip createTrip(TripBook tbook) {
	...
	private static void viewAllTrips(TripBook tripbook) {
	...
	// Activities
	private static void viewAllTripActivities(TripBook tbook, Trip trip) {
	...
	private static void editActivity(Trip trip) {
	...
	private static void editSelectedActivity(Trip trip, Activity activity) {
	...
	private static void editActivityLocation(Activity activity) {
	...
	private static void editActivityDate(Activity activity) {
	...
	private static void editActivityTime(Activity activity) {
	...
	private static void editActivityEstCost(Activity activity) {
